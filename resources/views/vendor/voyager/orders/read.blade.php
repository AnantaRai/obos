            ...
            <div class="panel panel-bordered" style="padding-bottom:5px;">
                ...
                <div class="panel-body" style="padding-top:0;">
                    ...
                    <div style="margin-top: 10px">
                        <img src="{{ productImage($product->image) }}" alt="product" style="width: 150px">
                        <li> <span style="font-weight: bold;">Product Id: </span>{{ $product->id }}</li>
                        <li><span style="font-weight: bold;">Product Name: </span>{{ $product->name }}</li>
                        <li><span style="font-weight: bold;">Product Price: </span>{{ $product->presentPrice() }}</li>
                        <li><span style="font-weight: bold;">Product Quantity: </span>{{ $product->pivot->quantity }}
                        </li>
                        @if ($product->pivot->count() > 1)
                        @if ($product->pivot->weight_in_pound)
                        <li><span style="font-weight: bold;">Weight: </span>{{ $product->pivot->weight_in_pound }} Pound
                        </li>
                        @endif
                        @if ($product->pivot->choice)
                        <li><span style="font-weight: bold;">Choice: </span>{{ $product->pivot->choice }}</li>
                        @endif
                        @if ($product->pivot->message)
                        <li><span style="font-weight: bold;">Message: </span>{{ $product->pivot->message }}</li>
                        @endif
                        @endif
                    </div>
                    <hr>
